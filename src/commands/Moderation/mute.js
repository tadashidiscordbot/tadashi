...
module.exports = {
    ...
    async runInteraction(client, interaction) {
      ...
      //if(interaction.member.roles.highest.comparePositionTo(target.roles.highest) <= 0) return interaction.reply("<:tadashi:1025083076159737937> \`❌ Erreur :\` Vous ne pouvez pas mute ce membre !")
      //if(!target.moderatable) return interaction.reply("<:tadashi:1025083076159737937> \`❌ Erreur :\` Je ne peux pas mute ce membre !")
