const {  EmbedBuilder, PermissionsBitField, ApplicationCommandOptionType, ChannelType, ApplicationCommandType } = require("discord.js");
const ms = require("ms");
        ...
        if(interaction.options.getSubcommand() === 'start') {
            ...
            client.giveawaysManager.start(gChannel, {
                ...
                messages: {
                    ...
                    giveawayEnded: "<:tada_end:1025082221855514685> **Giveaway terminé** <:tada_end:1025082221855514685>",
